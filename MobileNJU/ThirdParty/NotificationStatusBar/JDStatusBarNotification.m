                 ...
                 userInfo:(NSDictionary *)userInfo;
{
    UIView *view = [[self sharedInstance] showWithStatus:status
                                               styleName:styleName];
    [[self sharedInstance] setUserInfo:userInfo];
    [view setUserInteractionEnabled:YES];
    
    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(readUserInfo:)];
                 ...
                 userInfo:(NSDictionary *)userInfo;
{
    UIView *view = [[self sharedInstance] showWithStatus:status
                                               styleName:styleName];
    [[self sharedInstance] setUserInfo:userInfo];
    [[self sharedInstance] setObject:object];
    [view setUserInteractionEnabled:YES];
...
+ (void)readUserInfo:(UITapGestureRecognizer *)tap
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"getPushInfo" object:[[self sharedInstance] object] userInfo:[[self sharedInstance] userInfo]];
}
