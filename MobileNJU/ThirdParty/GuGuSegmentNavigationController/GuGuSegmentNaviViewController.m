...
//        }
//        
        barView = [[GuGuSegmentBarView alloc]initWithFrame:CGRectMake(0, 0, 320, kBarHeight) andItems:titleArray];
        
        barView.backgroundColor = RGBCOLOR(230, 230, 230);
        [self.view addSubview:barView];
        barView.clickDelegate = self;
        self.view.backgroundColor = [UIColor whiteColor];
        contentTable = [[GuGuLandscapeTableView alloc]initWithFrame:CGRectMake(0,  kBarHeight, 320, self.view.frame.size.height - kBarHeight ) Array:controllers];
