...
//    NSDictionary *data = [[NSDictionary alloc] initWithContentsOfFile:plistPath];
    NSArray* items = [NSArray arrayWithObjects:@"农学院",@"工学院",@"植物保护学院",@"资源与环境科学学院",@"园艺学院",@"动物科学技术学院",@"无锡渔业学院",@"动物医学院",@"食品科学技术学院",@"经济管理学院",@"公共管理学院（含土地管理学院）",@"人文社会科学学院",@"生命科学学院",@"理学院",@"信息科学技术学院",@"外国语学院",@"农村发展学院",@"金融学院",@"草业学院",@"国际教育学院",@"思想政治理论课教研部",@"其他",nil];
